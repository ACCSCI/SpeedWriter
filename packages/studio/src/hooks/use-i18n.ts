...
const strings = {
  ...
  "doctor.secretsFile": { zh: "加密密钥文件 (secrets.json)", en: "Encrypted key file (secrets.json)" },
  ...
  "breadcrumb.studio":          { zh: "Studio",       en: "Studio" },
  "breadcrumb.chat":            { zh: "对话",         en: "Chat" },
  "breadcrumb.book":            { zh: "书籍详情",     en: "Book" },
  "breadcrumb.bookSettings":    { zh: "书籍设置",     en: "Book Settings" },
  "breadcrumb.bookCreate":      { zh: "创建书籍",     en: "Create Book" },
  "breadcrumb.chapterN":        { zh: "第{n}章",      en: "Chapter {n}" },
  "breadcrumb.analytics":       { zh: "分析",         en: "Analytics" },
  "breadcrumb.services":        { zh: "服务",         en: "Services" },
  "breadcrumb.serviceDetail":   { zh: "服务详情",     en: "Service Detail" },
  "breadcrumb.projectSettings": { zh: "项目设置",     en: "Project Settings" },
  "breadcrumb.truth":           { zh: "真相档案",     en: "Truth Files" },
  "breadcrumb.daemon":          { zh: "守护进程",     en: "Daemon" },
  "breadcrumb.logs":            { zh: "日志",         en: "Logs" },
  "breadcrumb.genres":          { zh: "题材",         en: "Genres" },
  "breadcrumb.style":           { zh: "风格",         en: "Style" },
  "breadcrumb.import":          { zh: "导入",         en: "Import" },
  "breadcrumb.radar":           { zh: "雷达",         en: "Radar" },
  "breadcrumb.doctor":          { zh: "诊断",         en: "Doctor" },
